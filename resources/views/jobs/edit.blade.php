<x-layout>
    ...
    >
        ...
        >
            ...
            <x-inputs.text-area id="description"
                                name="description"
            ...
            <x-inputs.text-area id="requirements"
                                name="requirements"
                                label="Requirements"
                                rows="4"
            ...
            <x-inputs.text-area id="benefits"
                                name="benefits"
                                label="Benefits"
                                rows="4"
                                placeholder="Competitive salary, flexible working hours, and a great work environment."
            ...
            <x-inputs.select id="is_remote"
                             ...
                             :value="old('is_remote', $job->is_remote)"
            />
            ...
            <x-inputs.text-area id="company_description"
